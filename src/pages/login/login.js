...
export default () => {
  ...
  <section id='desktop'> 
    <section id='login-content-desktop'>
      <div id='background-orange'> <br> <br><br>
        <h2 id='welcome'> Bem vindo (a) ! <br> <br> </h2> <hr id='line'> <br> <br> <br> <br><br> <br> <br> <br>
           <p id='quality'> "A sua qualidade de vida é como um <span>bumerangue</span>, precisa ter movimento. <br> Todas as ações que você lançar, <br> voltarão em sua direção ainda mais fortes." </p> <br> <br><br> <br> <br> <br><br> <br> <br> <br>
      <h2 id='actions'> Melhore suas ações, <br> pratique atividade física! </h2>
       </div>
      </section> 
      <section class='login-container'>
      <figure> <img src='assets/imagens/logo.png' id='login-logo' alt='Logotipo QA- Qualidade de ações'> </figure><br>
      ...
      <p id='google-account'> Não tem uma conta? </p> <span id='register'>        CADASTRE-SE </span>
      <br><br>
